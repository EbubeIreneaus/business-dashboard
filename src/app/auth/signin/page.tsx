...
const SignIn: React.FC = () => {
  ...
  const formData = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      password: Yup.string().required("Please enter your account password").min(6, 'password must be 6 characters or longer')
    }),
    onSubmit: async (values) => {
      setIsFormProcessing(true)
      try {
        let req = await fetch(
          `${backendUrl}/auth/?email=${values.email}&password=${values.password}`,
        );
        let res = await req.json();

        if(!res.status){
          alert("could not process this request at the time, please try again later!")
  ...
  return (
    <div className="w-full min-h-dvh px-5 flex items-center justify-center">
      <div className="rounded-md border -mt-14 border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <h2 className="mb-5.5 inline-block text-4xl font-bold uppercase">
                IR Bussiness Analytic
              </h2>

              <p className="2xl:px-20">
                Welcome back 👋 to IR Business Analytic, your business success
                is our priority.
              </p>
              {/* bg svg image */}
          ...
          <div className="w-full  md:py-1 border-stroke py-20 dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1 block font-medium">Hello 🤩</span>
              ...
              <form onSubmit={formData.handleSubmit}>
                <div className="mb-4">
                  ...
                  id="email"
                    ...
                    isRequired
                    isInvalid={formData.touched.email && formData.errors.email?true:false}
                ...
                <div className="mb-6">
                  ...
                  id="password"
                    ...
                    isInvalid={formData.touched.password && formData.errors.password?true:false}
                ...
                <div className="mb-5">
                  <Button
                    ...
                    variant="shadow"
                    color="primary"
                    isLoading={isFormProcessing?true:false}
                    className="!px-20"
                  >
                    Login
                  </Button>
